          ...
          <div className="flex overflow-x-auto sm:grid sm:grid-cols-2 gap-6 pb-6 sm:pb-0 snap-x snap-mandatory scrollbar-hide">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="group p-6 bg-card rounded-2xl border border-border hover:border-primary/30 hover:shadow-lg transition-all duration-300 flex-shrink-0 w-[260px] snap-center"
              >
